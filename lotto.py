...
losowanko(przedzialy) #jedna para 2-1-1-1-1
losowanko(przedzialy, [2, 2, 2]) #2-2-2
losowanko(przedzialy, [3, 2, 1]) #3-2-1
losowanko(przedzialy, [3, 3]) #3-3
losowanko(przedzialy, [2, 2, 1, 1])#2-2-1-1
losowanko(przedzialy, [3, 1, 1, 1])#3-1-1-1
losowanko(przedzialy, [4, 1, 1])#4-1-1